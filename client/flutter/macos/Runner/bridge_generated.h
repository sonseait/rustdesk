...
WireSyncReturn wire_managed_get_status(void);

void wire_managed_configure(int64_t port_, struct wire_uint_8_list *control_plane_url);

void wire_managed_enroll(int64_t port_,
                         struct wire_uint_8_list *enrollment_token,
                         struct wire_uint_8_list *display_name);

void wire_managed_heartbeat(int64_t port_);

void wire_managed_renew_credential(int64_t port_);

void wire_managed_request_session_ticket(int64_t port_, struct wire_uint_8_list *target_device_id);

void wire_managed_request_session_ticket_for_rustdesk_id(int64_t port_,
                                                         struct wire_uint_8_list *target_rustdesk_id);

void wire_managed_deprovision(int64_t port_);
...
void wire_main_deploy_device(int64_t port_,
...
void wire_main_set_permanent_password_with_result(int64_t port_, struct wire_uint_8_list *password);
...
void wire_session_set_common(int64_t port_,
                             struct wire_uint_8_list *session_id,
                             struct wire_uint_8_list *key,
                             struct wire_uint_8_list *value);
...
int rustdesk_is_disable_installation(void);
...
static int64_t dummy_method_to_enforce_bundling(void) {
    ...
    dummy_var ^= ((int64_t) (void*) wire_managed_get_status);
    dummy_var ^= ((int64_t) (void*) wire_managed_configure);
    dummy_var ^= ((int64_t) (void*) wire_managed_enroll);
    dummy_var ^= ((int64_t) (void*) wire_managed_heartbeat);
    dummy_var ^= ((int64_t) (void*) wire_managed_renew_credential);
    dummy_var ^= ((int64_t) (void*) wire_managed_request_session_ticket);
    dummy_var ^= ((int64_t) (void*) wire_managed_request_session_ticket_for_rustdesk_id);
    dummy_var ^= ((int64_t) (void*) wire_managed_deprovision);
    ...
    dummy_var ^= ((int64_t) (void*) wire_main_deploy_device);
    ...
    dummy_var ^= ((int64_t) (void*) wire_main_set_permanent_password_with_result);
