/// Key name tables for legacy keyboard mode.
///
/// Copied verbatim from `flutter_legacy/lib/consts.dart`. The names are the
/// key identifiers the Rust core expects; renaming one breaks that key.
library;
