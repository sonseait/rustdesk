...
abstract class Rustdesk {
  ...
  String managedGetStatus({dynamic hint});

  FlutterRustBridgeTaskConstMeta get kManagedGetStatusConstMeta;

  /// Stores only the control-plane URL in normal client configuration.
  Future<String> managedConfigure(
      {required String controlPlaneUrl, dynamic hint});

  FlutterRustBridgeTaskConstMeta get kManagedConfigureConstMeta;

  /// Enrolls this device. The enrollment token and generated signing key never
  /// cross back to the Flutter presentation layer.
  Future<String> managedEnroll(
      {required String enrollmentToken,
      required String displayName,
      dynamic hint});

  FlutterRustBridgeTaskConstMeta get kManagedEnrollConstMeta;

  Future<String> managedHeartbeat({dynamic hint});

  FlutterRustBridgeTaskConstMeta get kManagedHeartbeatConstMeta;

  Future<String> managedRenewCredential({dynamic hint});

  FlutterRustBridgeTaskConstMeta get kManagedRenewCredentialConstMeta;

  /// Ticket material stays in Rust until the managed wire protocol carries it.
  Future<String> managedRequestSessionTicket(
      {required String targetDeviceId, dynamic hint});

  FlutterRustBridgeTaskConstMeta get kManagedRequestSessionTicketConstMeta;

  Future<String> managedRequestSessionTicketForRustdeskId(
      {required String targetRustdeskId, dynamic hint});

  FlutterRustBridgeTaskConstMeta
      get kManagedRequestSessionTicketForRustdeskIdConstMeta;

  Future<String> managedDeprovision({dynamic hint});

  FlutterRustBridgeTaskConstMeta get kManagedDeprovisionConstMeta;
...
class RustdeskImpl implements Rustdesk {
  ...
  String managedGetStatus({dynamic hint}) {
    return _platform.executeSync(FlutterRustBridgeSyncTask(
      callFfi: () => _platform.inner.wire_managed_get_status(),
      parseSuccessData: _wire2api_String,
      constMeta: kManagedGetStatusConstMeta,
      argValues: [],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta get kManagedGetStatusConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "managed_get_status",
        argNames: [],
      );

  Future<String> managedConfigure(
      {required String controlPlaneUrl, dynamic hint}) {
    var arg0 = _platform.api2wire_String(controlPlaneUrl);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_managed_configure(port_, arg0),
      parseSuccessData: _wire2api_String,
      constMeta: kManagedConfigureConstMeta,
      argValues: [controlPlaneUrl],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta get kManagedConfigureConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "managed_configure",
        argNames: ["controlPlaneUrl"],
      );
  ...
  Future<String> managedEnroll(
      ...
      required String displayName,
      dynamic hint}) {
    var arg0 = _platform.api2wire_String(enrollmentToken);
    var arg1 = _platform.api2wire_String(displayName);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_managed_enroll(port_, arg0, arg1),
      parseSuccessData: _wire2api_String,
      constMeta: kManagedEnrollConstMeta,
      argValues: [enrollmentToken, displayName],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta get kManagedEnrollConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "managed_enroll",
        argNames: ["enrollmentToken", "displayName"],
      );

  Future<String> managedHeartbeat({dynamic hint}) {
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_managed_heartbeat(port_),
      parseSuccessData: _wire2api_String,
      constMeta: kManagedHeartbeatConstMeta,
      argValues: [],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta get kManagedHeartbeatConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "managed_heartbeat",
        argNames: [],
      );

  Future<String> managedRenewCredential({dynamic hint}) {
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_managed_renew_credential(port_),
      parseSuccessData: _wire2api_String,
      constMeta: kManagedRenewCredentialConstMeta,
      argValues: [],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta get kManagedRenewCredentialConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "managed_renew_credential",
        argNames: [],
      );

  Future<String> managedRequestSessionTicket(
      {required String targetDeviceId, dynamic hint}) {
    var arg0 = _platform.api2wire_String(targetDeviceId);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_managed_request_session_ticket(port_, arg0),
      parseSuccessData: _wire2api_String,
      constMeta: kManagedRequestSessionTicketConstMeta,
      argValues: [targetDeviceId],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta get kManagedRequestSessionTicketConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "managed_request_session_ticket",
        argNames: ["targetDeviceId"],
      );

  Future<String> managedRequestSessionTicketForRustdeskId(
      {required String targetRustdeskId, dynamic hint}) {
    var arg0 = _platform.api2wire_String(targetRustdeskId);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_managed_request_session_ticket_for_rustdesk_id(port_, arg0),
      parseSuccessData: _wire2api_String,
      constMeta: kManagedRequestSessionTicketForRustdeskIdConstMeta,
      argValues: [targetRustdeskId],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta
      get kManagedRequestSessionTicketForRustdeskIdConstMeta =>
          const FlutterRustBridgeTaskConstMeta(
            debugName: "managed_request_session_ticket_for_rustdesk_id",
            argNames: ["targetRustdeskId"],
          );

  Future<String> managedDeprovision({dynamic hint}) {
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_managed_deprovision(port_),
      parseSuccessData: _wire2api_String,
      constMeta: kManagedDeprovisionConstMeta,
      argValues: [],
      hint: hint,
    ));
  }
...
class RustdeskWire implements FlutterRustBridgeWireBase {
  ...
  WireSyncReturn wire_managed_get_status() {
    return _wire_managed_get_status();
  }

  late final _wire_managed_get_statusPtr =
      _lookup<ffi.NativeFunction<WireSyncReturn Function()>>(
    'wire_managed_get_status',
  );
  late final _wire_managed_get_status =
      _wire_managed_get_statusPtr.asFunction<WireSyncReturn Function()>();

  void wire_managed_configure(
    int port_,
    ffi.Pointer<wire_uint_8_list> control_plane_url,
  ) {
    return _wire_managed_configure(port_, control_plane_url);
  }

  late final _wire_managed_configurePtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64,
              ffi.Pointer<wire_uint_8_list>)>>('wire_managed_configure');
  late final _wire_managed_configure = _wire_managed_configurePtr
      .asFunction<void Function(int, ffi.Pointer<wire_uint_8_list>)>();

  void wire_managed_enroll(
    int port_,
    ffi.Pointer<wire_uint_8_list> enrollment_token,
    ffi.Pointer<wire_uint_8_list> display_name,
  ) {
    return _wire_managed_enroll(port_, enrollment_token, display_name);
  }

  late final _wire_managed_enrollPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
            ffi.Int64,
  ...
  late final _wire_managed_enroll = _wire_managed_enrollPtr.asFunction<
      void Function(
        int,
        ffi.Pointer<wire_uint_8_list>,
        ffi.Pointer<wire_uint_8_list>,
  ...
  void wire_managed_heartbeat(int port_) {
    return _wire_managed_heartbeat(port_);
  }

  late final _wire_managed_heartbeatPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
    'wire_managed_heartbeat',
  );
  late final _wire_managed_heartbeat =
      _wire_managed_heartbeatPtr.asFunction<void Function(int)>();

  void wire_managed_renew_credential(int port_) {
    return _wire_managed_renew_credential(port_);
  }

  late final _wire_managed_renew_credentialPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
    'wire_managed_renew_credential',
  );
  late final _wire_managed_renew_credential =
      _wire_managed_renew_credentialPtr.asFunction<void Function(int)>();

  void wire_managed_request_session_ticket(
    int port_,
    ffi.Pointer<wire_uint_8_list> target_device_id,
  ) {
    return _wire_managed_request_session_ticket(port_, target_device_id);
  }

  late final _wire_managed_request_session_ticketPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Int64, ffi.Pointer<wire_uint_8_list>)>>(
      'wire_managed_request_session_ticket');
  late final _wire_managed_request_session_ticket =
      _wire_managed_request_session_ticketPtr
          .asFunction<void Function(int, ffi.Pointer<wire_uint_8_list>)>();

  void wire_managed_request_session_ticket_for_rustdesk_id(
    int port_,
    ffi.Pointer<wire_uint_8_list> target_rustdesk_id,
  ) {
    return _wire_managed_request_session_ticket_for_rustdesk_id(
      port_,
      target_rustdesk_id,
    );
  }

  late final _wire_managed_request_session_ticket_for_rustdesk_idPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Int64, ffi.Pointer<wire_uint_8_list>)>>(
      'wire_managed_request_session_ticket_for_rustdesk_id');
  late final _wire_managed_request_session_ticket_for_rustdesk_id =
      _wire_managed_request_session_ticket_for_rustdesk_idPtr
          .asFunction<void Function(int, ffi.Pointer<wire_uint_8_list>)>();

  void wire_managed_deprovision(int port_) {
    return _wire_managed_deprovision(port_);
  }

  late final _wire_managed_deprovisionPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
    'wire_managed_deprovision',
  );
  late final _wire_managed_deprovision =
      _wire_managed_deprovisionPtr.asFunction<void Function(int)>();
