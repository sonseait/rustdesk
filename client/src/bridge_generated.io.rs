...
#[no_mangle]
pub extern "C" fn wire_managed_get_status() -> support::WireSyncReturn {
    wire_managed_get_status_impl()
}

#[no_mangle]
pub extern "C" fn wire_managed_configure(port_: i64, control_plane_url: *mut wire_uint_8_list) {
    wire_managed_configure_impl(port_, control_plane_url)
}

#[no_mangle]
pub extern "C" fn wire_managed_enroll(
    port_: i64,
    enrollment_token: *mut wire_uint_8_list,
    display_name: *mut wire_uint_8_list,
) {
    wire_managed_enroll_impl(port_, enrollment_token, display_name)
}

#[no_mangle]
pub extern "C" fn wire_managed_heartbeat(port_: i64) {
    wire_managed_heartbeat_impl(port_)
}

#[no_mangle]
pub extern "C" fn wire_managed_renew_credential(port_: i64) {
    wire_managed_renew_credential_impl(port_)
}

#[no_mangle]
pub extern "C" fn wire_managed_request_session_ticket(
    port_: i64,
    target_device_id: *mut wire_uint_8_list,
) {
    wire_managed_request_session_ticket_impl(port_, target_device_id)
}

#[no_mangle]
pub extern "C" fn wire_managed_request_session_ticket_for_rustdesk_id(
    port_: i64,
    target_rustdesk_id: *mut wire_uint_8_list,
) {
    wire_managed_request_session_ticket_for_rustdesk_id_impl(port_, target_rustdesk_id)
}

#[no_mangle]
pub extern "C" fn wire_managed_deprovision(port_: i64) {
    wire_managed_deprovision_impl(port_)
}
