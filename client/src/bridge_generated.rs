...
fn wire_managed_get_status_impl() -> support::WireSyncReturn {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {
            debug_name: "managed_get_status",
            port: None,
            mode: FfiCallMode::Sync,
        },
        move || Ok(managed_get_status()),
    )
}
fn wire_managed_configure_impl(
    port_: MessagePort,
    control_plane_url: impl Wire2Api<String> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "managed_configure",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_control_plane_url = control_plane_url.wire2api();
            move |task_callback| Ok(managed_configure(api_control_plane_url))
        },
    )
}
fn wire_managed_enroll_impl(
    port_: MessagePort,
    enrollment_token: impl Wire2Api<String> + UnwindSafe,
    display_name: impl Wire2Api<String> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "managed_enroll",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_enrollment_token = enrollment_token.wire2api();
            let api_display_name = display_name.wire2api();
            move |task_callback| Ok(managed_enroll(api_enrollment_token, api_display_name))
        },
    )
}
fn wire_managed_heartbeat_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "managed_heartbeat",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || move |task_callback| Ok(managed_heartbeat()),
    )
}
fn wire_managed_renew_credential_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "managed_renew_credential",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || move |task_callback| Ok(managed_renew_credential()),
    )
}
fn wire_managed_request_session_ticket_impl(
    port_: MessagePort,
    target_device_id: impl Wire2Api<String> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "managed_request_session_ticket",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_target_device_id = target_device_id.wire2api();
            move |task_callback| Ok(managed_request_session_ticket(api_target_device_id))
        },
    )
}
fn wire_managed_request_session_ticket_for_rustdesk_id_impl(
    port_: MessagePort,
    target_rustdesk_id: impl Wire2Api<String> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "managed_request_session_ticket_for_rustdesk_id",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_target_rustdesk_id = target_rustdesk_id.wire2api();
            move |task_callback| {
                Ok(managed_request_session_ticket_for_rustdesk_id(
                    api_target_rustdesk_id,
                ))
            }
        },
    )
}
fn wire_managed_deprovision_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "managed_deprovision",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || move |task_callback| Ok(managed_deprovision()),
    )
}
