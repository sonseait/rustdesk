...
pub(crate) struct Peer {
    ...
    /// Set only after a managed credential has been verified for this live
    /// registration. It is deliberately not persisted in the peer database.
    pub(crate) managed_device_id: Option<Uuid>,
}
